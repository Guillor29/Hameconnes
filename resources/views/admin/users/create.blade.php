...
@section('content')
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6">
            <h2 class="text-lg leading-6 font-medium text-gray-900">Ajouter un utilisateur</h2>
            <p class="mt-1 text-sm text-gray-500">Créez un nouvel utilisateur en remplissant le formulaire ci-dessous.</p>
        </div>

...
@section('content')
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6">
            <h2 class="text-lg leading-6 font-medium text-gray-900">Modifier un utilisateur</h2>
            <p class="mt-1 text-sm text-gray-500">Modifiez les informations de l'utilisateur en utilisant le formulaire ci-dessous.</p>
        </div>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700">
                            Mot de passe <span class="text-sm text-gray-500">(laisser vide pour ne pas modifier)</span>
                        </label>
